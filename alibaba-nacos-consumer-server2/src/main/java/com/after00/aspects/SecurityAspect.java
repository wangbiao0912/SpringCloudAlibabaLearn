...
public class SecurityAspect {
    @Around("execution(public * com.after00.controller.*.*(..)) ")
    public Object process(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            rvt= BaseResponse.getFailResponse(ResponseCodeEnum.fail.key,"", JSON.toJSONString(e.getMessage()));
        } catch (Exception e) {
            rvt = BaseResponse.getFailResponse(ResponseCodeEnum.fail.key, "", "服务端问题，请联系管理员");
            e.printStackTrace();
